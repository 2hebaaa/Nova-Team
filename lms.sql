...
--
-- Host: 127.0.0.1
-- Generation Time: May 08, 2026 at 01:10 AM
...
CREATE TABLE `activity_logs` (
  `id` int(11) NOT NULL,
  `user_type` enum('student','doctor','admin') DEFAULT NULL,
...
--
ALTER TABLE `courses`
  ADD CONSTRAINT `courses_ibfk_1` FOREIGN KEY (`doctor_id`) REFERENCES `doctors` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `lectures`
  ...
  ADD CONSTRAINT `lectures_ibfk_2` FOREIGN KEY (`uploaded_by`) REFERENCES `doctors` (`id`);
...
ALTER TABLE `sections`
  ...
  ADD CONSTRAINT `sections_ibfk_2` FOREIGN KEY (`uploaded_by`) REFERENCES `doctors` (`id`);
